...
class AddPost extends Component {
    ...
    handleSubmit = ev => {
        ...
        const {title, content, stars} = this.state;   // TREBAO BIH IZ STATE-A, IZVUCU I stars
        ...
        const post = {
            ...
            // favorites: 0,             // MOZDA BI TREBALO DA SE OVAJ PROPERTI NE ZOVE FAVORITES
                                      // ODNOSNO MOGU MU DEFINISATI DA SE IPAK ZOVE stars

            stars,    // DAKLE PROSLEDJUJE SE IZ PROPS-A

            // JA NAIME NE ZELIM DA SE OVAJ PROPERTI ZOVE favorites, A I NE ZELIM VISE DUMMY DATA

            // OVO CE RESITI STA CE SE SLATI
...
// OVDE SU DO SADA ODLUCIVALAI DEFAULT PROPSI
