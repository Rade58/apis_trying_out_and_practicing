...
exports.getAllPosts = functions.https.onRequest((request, response) => {
    ...
    const queryDocumentSnapshot = await firestore.collection('posts').get()

    // POSTO JE QueryDocumentSnapshot INSTANCA, USTVARI ARRAY LIKE, MOGU DA NA NJEMU PRIMENJUJEM map METODU
    // OPET ZELIM DA REDEFINISEM NIZ, TAKO DA SE id DOKUMENTA I OSTALI PROPERTIJI DOKUMENTA, BUDU ZAJEDNO
    // U JEDNOM OBJEKTU
