...
## OBJASNJENJE ZASTO SE NE DISPLAYUJE displayName NAKON RENDERINGA REACT ELEMENTA, REPRESENTED BY CurrentUser (OVO SAM NAJBOLJE OBJASNIO KOMENTARIMA U POSLEDNJEM, DOLE PRIKAZANOM NASLOVU)
...
DAKLE SAM ORELOAD-UJEM STRANICU I DESICE SE PONOVO CITANJE displayName-A, KADA CE ON 'DOWN THE PROP PIPELINE' BITI PROSLEDJEN CurrentUser KOMPONENTI, KOJA JE KAO STO ZNAM SADA MOUNTED
