...
// NEMOJ TO DA MESAS SA SPREAD SINTAKSOM

// POMENUTA SINTAKSA SE KORISTI NA OBJEKTU I ZOVE SE            JSX SPREAD ATRIBUT

// AKO IMAM     let a = {x: 1, y: 2}            ONDA OVO        <Nesto x={a.x} y={a.y} />
// MOZE SE NAPISTI I OVAKO              <Nesto {...a} /> 

// A U OKVIRU OVOG PRIMERA, OVO CE TI BITI JASNO KADA POGLEDAS Post KOMPONENTU KOJ USI RANIJE KREIRAO
...
// I TAK OJE IZVRSEN COMPOSITION, JER SU SVI TI React ELEMENTI 'NESTED' U section-U
