...
class PostPage extends Component {
    ...
    // JA TO TADA NISAM MORAO URADITI, JER ONI UVEK POSTAJU RENDERED DEO APLIKACIJE (ALI GOOD PRACTICE JE DA SE 
    // IPAK DEFINISE UNSUBSCRIPTION)
