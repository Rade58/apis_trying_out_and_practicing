...
MILIM DA JE U OVOM SLUCAJU proxy_pass KOJI SAM RANIJE DEFINISAO ZA /, UPRAVO PREUSMERIO NA 3000 SERVIRANJE

PROCITAJ PONOVO MD FAJL U KOJEM JE OBJASNJENA Nginx KONFIGURACIJA (ON TI JE U FOLDERU `d) SETUP SERVER-A`)
