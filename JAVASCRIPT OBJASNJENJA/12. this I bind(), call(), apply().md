...
class Blah {
    ...
    // I this TREBA DA BUDE UVEK Blah INSTANCA
    // BEZ OBZIRA GDE SE OVA FUNKCIJA INVOCIRA
    metoda = () => {
...
.then(blahInstanca.metoda).then(blahInstanca.metoda1).then(blahInstanca.metoda2)
```
...
// SVRSENO MI JE JASNO KOJOJ OD METODA JE VREDNOST ZA this PREDEFINED, ODNOSNO BINDED
```

NE ZNAM ZASTO JE this, U PREDHODNIM SLUCAJEVIMA undefined; ZA METODE metoda1 I metoda2; PO MOJOJ PROCENI, ODNSOSNO PO MOJOJ PREDPOSTAVCI TO BI TREBALO DA BUDE window (OSTAJE OVDE PODSETNIK DA VIDIM ZASTO JE TO TAKO)