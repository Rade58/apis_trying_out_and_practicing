...
## *'NEGACIJA'(IZOSTAVLJANJE)* PSEUDOKLASA I *'PRAZNO'* PSEUDOKLASA
...
JEDINO STO JE RADILO, I TO FIREFOX BROWSER-U, JESTE SLEDECA PSEUDO KLASA, KOJA RADI ISTO ONAKO KAKO BI TREBALO :matches() da RADI

REC JE O PSEUDO KLASI
...
A ISTINA JE, KAO STO SAM REKAO DA FIREFOX PODRZAVA, SAMO POMENUTU **:-moz-any** PSEUDO KLASU