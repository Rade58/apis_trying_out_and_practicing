...
table.neka_tabela tr:nth-of-type(even) td:nth-of-type(odd) {    /*SVAKI NEPARNI PARNI TR I NEPARNI TD U TOM  TR-U */
    background-color: tomato;
    color: #fff;                /*OVO JE BITNO JER PRI OVOM STILU, NA BELOJ POZADINI SE PRIKAZUJE CRNI TEKST*/
}                               /* A NA TAMNOJ POZADINI SE PRIKAZUJE BELI ILI TRAQNSPARENTNI TEKST */
                                /*  OVU     #fff BOJU MORAM DODATNO ISPITATI  */
...
UGLAVNOM NA OVOAJ NACIN SAM POSTIGAO DA TABELA BUDE TAKVA DA JOJ CELIJE IMAJU TAKAV STIL DA PODSECAJU NA SAHOVSKU TABLU (I OPET NAPOMINJEM U KORISNOT   **#fff**   BOJE FONTA)
...
const star = document.createTextNode('&#x2605'); // OVO CE MI POSLUZITI ZA ONU TABELU, U KOJU CU DA UMECEM
                                                 // ZVEZDICE
