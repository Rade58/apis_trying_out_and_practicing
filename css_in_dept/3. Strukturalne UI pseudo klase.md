...
> JA SAM PROBAO, DA UPOTREBIM OVU :matches() PSEUDO KLASU, ALI ONA, NI U JEDNOM BROWSER-U, NIJE FUNKCIONISALA
...
### :is()     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  (:matches() JE PROMENILO IME, ODNOSNO DEPRECATED JE, I SADA BI OVA PSEDU KLASA TREBALA DA IMA NJENE OSOBINE)
...
ONO STO SAM SAZNAO, JESTE DA SE MORA, U BROWSERU CHECKIRATI NESTO STO SE ZOVE **"Experimental Web Platform features" flag** DA BI SE MOGAO KORISTITI **:matches()**
