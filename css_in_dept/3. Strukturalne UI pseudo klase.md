...
<div class="neki_kontejner">
    ...
    <ul>
        <li>item 1</li>         <!-- OVAJ LIST ITYMEM JESTE FIRST CHILD, I NA NJEMU CE SE APLICIRATI STIL -->
        <li>item 2</li>
        <li>item 3
...
I ZAISTA KADA POGLEDAM STRANICI, SITUACIJA, U POGLEDU STILA, JESTE ONAKVA, KAKVA JE PRIKAZANA, GORNJIM KOMENTARIMA
