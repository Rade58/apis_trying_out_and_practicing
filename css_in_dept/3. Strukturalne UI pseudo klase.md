...
I CISTO DA NE POBRKAM TERMINE, OVAJ PSEUDO ELEMENT, RETURN-UJE ELEMENT, TAKO DA GA MOGU KORISTITI SA SELECTORS API-EM

```JAVASCRIPT

console.log(    document.querySelectorAll('div.neki_blah div:not(:nth-of-type(2n + 1))')    ); //-->

//-->       NodeList(4) [div, div, div, div]              (PARNI DIV-OVI)
//                          0: div
//                          1: div
//                          2: div
//                          3: div
