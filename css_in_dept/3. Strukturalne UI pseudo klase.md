...
### DRUGI PRIMER (TAMO GDE SAM GA PRONASAO, KAZU DA JE BESKORISNA STVAR, ALI DOBRO DEMONSTRIRA, 'SELEKTUJUCE' MOGUCNOSTI, POMENUTIH PSEUDO KLASA)
...
### SLEDECI PRIMER, JE (KAKO KAZE AUTOR TUTORIJALA, KOJI PRATIM), TAKODJE USELESS, ODNOSNO BESKORISTAN, A REC JE O STILIZOVANJU ELEMENATA, NA TAKAV NACIN DA IZGLEDAJU KAO AMERICKA ZASTAVA, A SELEKTOVANJE SE NARAVNO VRSI UZ KORISCENJE STRUCTURAL UI PSEUDO KLASA
...
[UTF SIMBOLI I KAKO SE KORISTE U HTML-U](https://www.w3schools.com/charsets/ref_utf_symbols.asp) (AKO ZABORAVIM) (NAPOMENA DRUGACIJE SE KORISTE U JAVASCRIPT-U)
[JOS JEDAN LINK ZA SIMBOLE](https://www.fileformat.info/info/unicode/char/2605/index.htm)
...
DRUGA TABELA, KOJA CE BITI NESTED U PRVOM TD-U, PRVOG TR-A (TABELA KOJA CE OBUHVATATI ZVEZDICE)
...
// (MOZDA JE TO JEDINI DEO, KOJI SE DIREKTNO ODNOSI NA TEMU OVE LEKCIJE)
...
CSS BESKORISNE ZASTAVE IZGLEDA OVAKO
...
MOZDA JE PRAVLJENJE OVE ZASTAVE NA OVAKAV (MOJ) NACIN BILO SUVISNO, A SADA CU ISTU TABELU FORMIRATI PO ESTELLE-INOM RECEPTU

ZATO CU PRVO KREIRATI TAJ, POCETNI GRID TABELE SASTAVLJEN OD KOLONA I REDOVA

DAKLE, KREIRACU, JEDNU TABELU SASTAVLJENU OD 13 REDOVA

I U SVAKOM REDU CE BITI PO 16 CELIJA, U KOJIMA CE BITI NESTED TEKST 'cell'
...
STO SE TICE CSS-A, ON CE IZGLEDATI OVAKO ( NAIME OVDE JE BITNO DA CSS U VELIKOJ MERI KORISTI STRUKTURALNE CSS PSEUDO KLASE, CIME MOGU BOLJE SAGLEDATI MOGUCNOSTI, OVIH PSEUDO KLASA):
...
/* FONT ZA SVAKI TABLE DATA, ALI I PADDING */
#flag td {
...
KAO STO SE DA PRIMETITI, PREDHODNI PRIMER (ESTELLINA VERZIJA) JE KORISTIO RAZNE STRUKTURALNE UI PSEUDO KLASE, I NA TAJ NACIN, MOGLE SU SE DOBRO SAGLEDATI MOGUCNOSTI, POMENUTIH PSEUDO KLASA

AKO BUDEM DALJE ZELEO DA KREIRAM ZASTAVU NA DRUGI NACIN, TREBALO BI DA POGLEDAM, SLEDECI PRIMER, A TO JE [codepen](https://codepen.io/pcridesagain/pen/GweAj) Patrick-A Cox-A

ALI I SLEDCI PRIMER (MOZDA VAZNIJI JER JE PITANJE NA NEKIM INTERVIEW-IMA):

[CHRISOPER-OVA ZASTAVA](http://christopher.org/american-flag-in-css/)

NAJBOLJE BI BILO DA ODRADIM OVO KADA BUDEM DOBRO SAVLADAO box-shadow I text-shadow  PROPERTIJE, ALI I GRADIENTE

OVA ZASTAVA JE SAMO JEDAN `<b></b>` ELEMENT (DAKLE U NAJVECOJ MOGUCOJ MERI JE KORISCEN CSS, KAKO BI SE NAPRAVILA, POMENUTA ZASTAVA)
...
## *'NEGACIJA'(IZOSTAVLJANJE)* PSEUD OKLASA ; *'PRAZNO'* PSEUDOKLASA; *'MATCHES'* (MNOGE PSEUDO KLASE U OVOJ GRUPI NISU PODRZANE (PRVENSTVENO ONE VEZANE ZA 'MATCHING'))

`NEGACIJA:` **:not()**    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    `PRAZNO:` **:empty**

### :not()

DAKLE, ONO STO MI CSS3 TAKODJE PRUZA, JESTE MOGUCNOST EXCLISION-A

TAKO DA MOGU DA, PRILIKOM SELEKTOVANJA JA MOGU 'ZAHTEVATI' SLEDECE:
> MATCH-UJ SVE OVE ELEMENTE I IZOSTAVI, OVE DRUGE ELEMENTE
...
```HTML
    ...
    <div id="divkont">
        <div>1</div>
        <div>2</div>
        <div class="excludeMe">3</div>
        <div>4</div>
        <div class="excludeMe">5</div>
        <div>6</div>
    </div>

```

SADA CU MATCHE-OVATI, SVE DIV-OVE, OVOG KONTEJNERA, A ONO STO CE BITI IZOSTAVLJENO JESU ONI SA APLICIRANOM `.excludeMe` KLASOM
...
I ZAISTA STILOVI SE NISU APLICIRALI NA TRECI I PETI DIV `#divkont` KONTEJNERA

AKO ZELIM DA SELEKTUJEM SVE DIV-OVE, ALI DA IZ TE SELEKCIJE ISKLJUCIM ONE KOJI IMAJU `title` ATRIBUT, MOGU NAPISATI SLEDECE

```HTML

<style>

    section div:not([title]) {
...
<section>
    <div>1</div>
    <div title="blah">2</div>
    <div>3</div>
    <div>4</div>
    <div title="blah blah">5</div>
</section>

```

ILI, MOGAO SAM DA KORISTIM I STRUKTURALNU UI PSEUDO KLASU, KOJA IMA PREFIKS **nth**

```CSS
    section div:not(:nth-of-type(4)) {           /* SAMO CETVRTI DIV NECE DOBITI OUTLINE */
        outline: rgb(204, 23, 50) solid 4px;
    }
```

DAKLE, OVO JE VEOMA KORISNO I POWERFULL, ALI **TREBAM DA ZNAM, JOS NESTO O OVOME**:

&nbsp;&nbsp;&nbsp;&nbsp;   ***ONO STO, SAMO MOZE DA SE KORISTI U **ZAGRADI** NEGACIJE JESTE NESTO STO SE ZOVE `SIMPLE SELECTOR`, ODNOSNO TO NE SME BITI RELATIONAL SELECTOR (TAKO DA CHILD, DESCENDANT, ADJACENT SIBLINGS, GENERAL SIBLING SELEKTORI NE DOLAZE U OBZIR, ODNOSNO KOMBINATORI NE DOLAZE U OBZIR)***

> ALI ONO STO SE MOZE STAVLJATI JESU: **ID**, **CLASS** SELEKTORI, ZATIM **ATRIBUT** SELEKTORI, **UI PSEUDO KLASE**

:not() DE DOAJE NIKAKVU VREDNOST SPECIFICITY-JU

ALI OVO DAJE SPECIFICITY-JU:

&nbsp;&nbsp;&nbsp;&nbsp;                **div:not(#id)**

DAKLE, ONO STA SE STAVI KAO ARGUMENT, POJACAVA SPECIFICITY

NAIME, **`*`**, ZATIM **+**, ZATIM **>**, ZATIM **~(TILDE)** ***NEMAJU VREDNOST, U POGLEDU SPECIFICITY-JA***

ISTI SLUCAJ JE I SA **:not()**

NEGACIJA SELEKTOR, SAM PO SEBI NEMA VREDNOST, U POGLEDU SPECIFICITY-JA, ALI MU PROSLEDJENI ARGUMENT, INCREASE-UJE SPECIFICITY
...
<style>
    div.neki_blah div:not(:nth-of-type(2n + 1)) {
        background-color: tomato;
    }
</style>
...
DAKLE U PREDHODNOM PRIMERU, SELEKTOVANI SU PARNI ELEMENTI, TAKO STO **NISU IZABRANI NEPARNI**

ILI, MOZDA JE PRAVILNIJE RECI DA SU **IZABRANI, SVI DRUGI DIV ELEMENTI, IZUZEV NEPARNIH**

I CISTO DA NE POBRKAM TERMINE, OVA PSEUDO KLASA, RETURN-UJE ELEMENT, TAKO DA GA MOGU KORISTITI SA SELECTORS API-EM

```JAVASCRIPT

console.log(    document.querySelectorAll('div.neki_blah div:not(:nth-of-type(2n + 1))')    );      //-->

//-->       NodeList(4) [div, div, div, div]        (PARNI DIV-OVI) (ODNOSNO SVI ONI DIVOVI, KOJI NISU NEPARNI)
//                          0: div
//                          1: div
//                          2: div
//                          3: div
...
*******
NASTAVLJAM DALJE SA NEGACIJOM, A OVAKVA NEGACIJA, ODNOSNO OVAKVO KORISCENJE :not() , KOJE CU PRIKAZATI, FUNKCIONISE SAMU U SAFARI BROWSERU

### :not(simpleSelector1, simpleSelector2, ..., simpleSelectorN)

NAIME, U OVOM SLUCAJU MOZE SE DODATI LISTA SIMPLE (NE KOMBINATORI) SELECTORA, I BICE SELEKTOVANO SVE IZUZEV ONOGA STO, POMENUTI SIMPLE SELECTORI SELEKTUJU

A POSTO NEMAM MAC, NE MOGU SE IGRATI SA, POMENUTIM NACINOM SELEKTOVANJA SA :not(s1,s2,..,sN) PSEUDO KLASOM

*******

POSTO SAM SE TIME POZABAVIO, SADA CU PRECI NA SLEDECU PSEUDO KLASU

TO JE:

### :empty

OVA PSEUDO KLASA SELEKTUJE ELEMENTE, KOJI SU POTPUNO PRAZNI, ILI SE U NJIMA NALAZI COMMENT

NAIME, SAM PO SEBI EMPTY NE IZGLEDA NESTO KORISNO, ALI **:not(:empty)** SE CINI KAO MORE POWERFULL

```HTML

<div class="blah_div">
    <p>Paragraf el bla</p>
    <div>Neki tekst u divu</div>
    <div></div>
    <div><!-- OVAJ DIV JE PRAZAN --></div>
    <p>Paragraf element blah</p>
    <p></p>
</div>
...
POSTOJI JOS JEDNA PSEUDO KLASA, KOJA NIJE SUPPORTED, OD STRANE BROWSERA; A TA SE PSEUDO KLASA BAVI ISTO 'PRAZNINOM' KAO I PREDHODNA, ALI REC JE O DRUGACIJIJ 'PRAZNINI'

### :blank

OVA PSEDO KLASA BI TREBALO DA SELEKTUJE ELEMENT U KOJI SU , SAMO NESTED WHITESPACE-OVI, ODNOSNO BLANK SPACES

MEDJUTIM, OVA KLASA, KAO STO SAM REKAO NIJE PODRZANA, VEC POSTOJI JEDNA KLASA, ISTE NAMENE, KOJA JE SAMO PODRZANA U FIREFOX-U
...
```HTML
<!-- POSMATRAM SLEDECE ELEMENTE, SAMO U FIREFOX-U -->
...
```CSS
    /* DODACU, TOMATO BORDER, ONOM ELEMENTU, U KOJI SU NESTED SAMO BLANK SPACE-OVI */

    div.prazniEl > :-moz-only-whitespace {
        border: tomato solid 8px;
    }

    /* PROVERIO SAM U FIREFOX-U, I SVA TRI NESTED DIVA SU SELEKTOVANA */
    /* IZGLEDA DA IAKO SE SAMO U ELEMENTU NALAZI KOMENTAR, TAJ ELEMENT SE TAKODJE SELEKTUJE POMENUTOM
    PSEUDO KLASOM */
    /* A TAKODJE, IAKO NISAM STAVIO WHITESPACE, U DRUGOM DIV-U, I ON JE SELEKTOVAN, POMENUTOM PSEUDO KLASOM */
...
SLEDECA PSEUDO KLASA JE

### :root

U HTML-U, OVA PSEUDO KLASA SE SELEKTUJE **`<html></html>`** ELEMENT, ODNOSNO SELEKTUJE document root

U XML-U, NA xml ELEMENT (xml markup MI JE POTPUNO NEPOZNAT)

U SHADOW DOM-U, OVO MOZE SELEKTOVATI, NESTO DRUGO (ISPITACU, NEKOM DRUGOM PRILIKOM U CILJU USTEDE VREMENA)

KADA SE KORISTE **rem** JEDINICE, U SLUCAJU TEKSTA, DOBRO JE DEKLARISTAI ***font-size*** STIL U POMENUTOM :root ELEMENTU

ESTELLE KAZE DA SE :root TREBA STILIZOVATI SAMO ONDA, KADA JE head OTKRIVENO (TO SAM URADIO U JEDNOJ VEZBI (KADA SAM DISPLAY-OVAO BODY, ONDA SAKRIO SVE U BODY-JU, OSIM POSLEDNJEG STYLE, KOJEM SAM TAKODJE DODAO contenteditable ATRIBUT))

STA JE MISLILA POD STILIZOVANJEM :root -A, U TOM SLUCAJU MI NIJE JASNO, A NIJE NI NJOJ (TAKO DA TO MORAM DODATNO ISPITATI)

STO SE TICE CSS VARIJABLI, ODNOSNO CSS CUSTOM PROPERTIJA, NJIH TREBAM DEFINISATI U ROOT-U
...
SLEDECA PSEUDO KLASA, JESTE

### :matches()   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  (TREBALO BI DA BUDE KORISNI syntactic sugar)

ZA SADA JEDINO PODRZAN U SAFARI BROWSER-U

> FORMERLY KNOWN AS :any()

OVA PSEUDO KLASA, TREBALO BI DA PRIHVATA LISTU, VALIDNIH SELEKTORA, KAO ARGUMENATA

PRE NEGO STA BILO STA DRUGO KAZEM, MISLIM DA TREBAM RECI SLEDECE:

**MISLIM DA JE NAMENA OVE KLASE, DA OLAKSA, ODNOSNO DA OMOGUCI KRACI CODE, PRILIKOM DEFINISANJA KOMBINOVANIH SELEKTORA (ODNOSNO ONIM SELEKTORIMA, U KOJIMA UCESTVUJU KOMBINATORI)**

NAJBOLJE JE DA OVAJ SELEKTOR PRIKAZEM PUTEM PRIMERA (ON JE USTVARI NESTO STO JE USVOJENO IZ SASS-A)

NAIME, KREIRACU NEKOLIKO ELEMENATA

```HTML

<nav><h1>Ovde se stavlja navigacija</h1></nav>
<section><h1>Neki tekst sekcije</h1></section>
<article><h1>Ovde je neki clanak</h1></article>
<aside><h1>Neki sporedni tekst</h1></aside>
<div title="neki div" >Neki div blah</div>

```

NORMALNO, **BEZ** ***:matches()*** PSEUDO KLASE, MORAO BIH SELEKTOVATI, SVAKIH OD ***h1*** ELEMENATA, TAKO STO BIH NAPISAO 4 SELEKTORA; UPRAVO OVAKO

```CSS

    nav h1, section h1, article h1, aside h1, [title] h1 {
        color: #BADA55;
    }

```

A SA, ***:matches()*** PSEUDO KLASOM,, TO ISTO BIH DEFINISAO OVAKO

```CSS

:matches(nav, section, article, aside, [title]) h1 {
    color: #BADA55;
}

```

DAKLE, U PRVOM SLUCAJU SAM IMAO MNOSTVO DEFINISANIH **DESCENDANT SELEKTORA** (h1 JE DESCENDANT), DOK UZ POMOC :matches() SINTAKSICKOG SECERA, *'DEFINISEM SAMO JEDAN'* DESCENDANT SELEKTOR

> JA SAM PROBAO, DA UPOTREBIM OVU :matches() PSEUDO KLASU, ALI ONA, NI U JEDNOM BROWSER-U, KOJI JA MOGU DA KORISTIM, NIJE FUNKCIONISALA

>TO JE ZATO STO OVA PSEUDO KLASA, JESTE PODRZANA SAMO U **SAFARI** BROWSER-U

> ALI POSTOJE PSEUDO KLASE, KOJE JE MOGU ZAMENITI

*******

### :-moz-any()   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   :-webkit-any()  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (EKSPERIMENTALNE)

JEDINO STO JE RADILO, I TO FIREFOX BROWSER-U, JESTE POMENUTA PSEUDO KLASA, KOJA RADI ISTO ONAKO KAKO BI TREBALO :matches() DA RADI

A ZA webkit VENDOR, KORISTIM PSEUDO KLASU SA -webkit PREFIKSOM

A ZA moz VENDOR, KORISTIM PSEUDO KLASU SA -moz PREFIKSOM

MORAO BI DAKLE, DA IMAM DVA SELEKTORA, I ZA WEBKIT, A I ZA FIREFOX

POSTO I MICROSOFT EDGE BROWSER PRELAZI NA WEBKIT, I U NJEGOVOM SLUCAJU CE SE MOCI SELEKTOVATI ELEMENTI, UZ POMOC  :-webkit-any()
...
ZA :-webkit-any KAZU DA, INCORRECTLY HANDLUJE SPECIFICITY

*******

**KASNIJE SAM SAZNAO DA CE `:matches()` BITI ZAMENJENO SA SLEDECOM PSEUDO KLASOM:**

### :is()     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  (:matches() JE PROMENILO IME, ODNOSNO DEPRECATED JE, I SADA BI :is() PSEUDO KLASA TREBALA DA IMA NJENE OSOBINE)

MEDJUTIM NI OVA PSEUDO KLASA NE FUNKCIONISE, NI U JEDNOM BROWSER-U

*******
*******

ONO STO SAM SAZNAO, JESTE DA SE MORA, U BROWSERU CHECKIRATI NESTO STO SE ZOVE **"Experimental Web Platform features" flag** DA BI SE MOGAO KORISTITI **:matches()**, U BROWSERU, KOJI NIJE SAFARI

TO NISAM PROBAVAO, JER NE VIDIM TRENUTNO NEKU POTREBU U POGLEDU TOGA

>NA ONO STO SE CEKA JESTE **:is()** PSEUDO KLASA, KOJA BI ZAMENILA, UPOTREBU, SVIH POMENUTIH KLASA (VEZANIH ZA 'MATCHING SINTAKSICKI SECER' ILI ISECERE)

ODNOSNO, TACNIJE RECENO *:matches()* JE PREIMENOVANO U **:is()** U SPECIFIKACIJAMA

*******
*******

TREBA DODATI, DA JE OVAKAV PRINCIP PRIMENJEN U SASS-U KOD NESTINGA, I DRUGIH CSS PREPROCESSORS (SASS TEK TREBAM NAUCITI)

DAKLE CILJ JE IZBECI, MANUELNO PISANJE SVIH KOMBINOVANIH, SELEKTORA

STO RADIM NA POMENUTI NACIN
...
OVAJ KOMBINATOR JE UKLONJEN IZ SPECIFIKACIJA

ON JE TREBAO DA POSTOJI, ALI JE UKLONJEN

NECU SE TRUDITI DA PRONADJEM DA LI JE OVAJ COMBINATOR NEGDE PODRZAN

U SUSTINI ON SE MOGAO INTERPRETIRATI KAO:

> PRONADJI ELEMENT, KOJI JE REFERENCIRAN OD STRANE DRUGOG ELEMENTA, ODNOSNO KOJI REFERENCIRAN NA TAKAV NACIN DA JE REFERENCA, USTVARI VREDNOST ATRIBUTA, TOG DRUGOG ELEMENTA

SINTAKSA BI BILA SLEDECA
...
OVAJ KOMBINANTOR BI BIO DOBAR ZA input-OVE I lable-OVE

BIO BI TAKODJE DOBAR ZA ARIA-U; I TO JE ZATO STO SE, MNOGO PUTA U ARIA-I, USTVARI 'GOVORI': "LABLED BY THIS OTHER THING"

TAKODJE BI BIO DOBAR I ZA datalist ELEMENTE (TREBAO BI OBNOVITI OVAH HTML5 ELEMENT)

## PARENT SELECTOR (JOS UVEK NIJE SUPPORTED)

ORIGINALNO, OVAJ SELECTOR JE *TREBAO DA IZGLEDA OVAKO*:

*E! > F*

DA NIJE IZBACEN IZ SPECIFIKACIJA, OVAJ SELEKTOR

BI U SINTAKSI KORISTIO, ISTI ZNAK (VECE OD), KAO I KOD CHILD SELECTOR-A, ALI S TIM STO BI SE PORED CHILD SELEKTORA (LEVI DEO), NASAO I ZNAK UZVIKA (!)

MEDJUTIM **PARENT SELEKTOR CE IZGLEDATI OVAKO**:

*ODNOSNO TO NIJE PARENT SELECTOR VEC **RELATIONAL PSEUDO CLASS***

**:has**        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (POGLEDAO SAM [canuise](https://caniuse.com/#search=%3Ahas) I OVAJ SELEKTOR, ODNOSNO PSEUDO KLASA NIJE SUPPOTED)

A IDEJA JE DA SE OVA PSEUDO KLASA BIRA ELEMENT, KOJI CONTAIN-UJE, ELEMENTE, CIJI SU SELECTORI, DODATI, KAO ARGUMENTI :has() PSEUDO KLASI

```CSS
/* OVAJ SELECTOR CE SELEKTOVATI header ELEMENT, SAMO AKO ON CONTAIN-UJE, SVE h ELEMENTE NABROJANE, KAO ARGUMENTE */

header:has(h1, h2, h3, h4, h5, h6) {

}

/* ILI SELEKTOVANJE header-A, KOJI NE CONTAIN-UJE, NI JEDAN OD h ELEMENATA */
...
/* ILI SELEKTOVANJE header-A, KOJI IMA BILO STA OSIM h ELEMENATA */
...
*******
*******
OVDE SE ZAVRSAVA PRICA, VEZANA ZA STRUKTURALNE UI PSEUDO KLASE (BAR ZA SADA)
*******
*******
*******

## NABROJACU SADA, SVE STRUCTURAL UI PSEUDO CLASSES, SA KOJIM SAM SE UPOZNAO DO SADA
...
***SA (An + B) KARAKTERISTICNIM ARGUMENTOM: (ARGUMENTI MOGU BITI I odd I even )***
...
***SUPROTNO OD NEGACIJE (ODNOSNO SELKTOVANJE SVIH ELEMENATA CIJE SELEKTORI DODATI KAO ARGUMENTI MATCH-UJU ELEMENTE)***

**:is()** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (TEK CE BITI SUPPORTED SVUDA, ODNOSNO :matches() CE PROMENITI IME U OVU PSEUDO KLASU)

**:-moz-any()** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (SUPPORTED U FIREFOX-U)

**:-webkit-any()** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (SUPPORTED U WEBKIT BROWSER-IMA) (POGRESNO HANDLE-UJE SPECIFICITY)

**:matches()** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (SUPPORTED U SAFAI BROWSER-U)

*******

***SELEKTOVANJE PRAZNIH ELEMENATA***

**:empty** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (AKO ELELEMENT IMA *<!-KOMENTAR-->* ISTO SE SMATRA DA JE EMPTY)

**:-moz-only-whitespace** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (AKO ELELEMENT IMA, NESTED *<!-KOMENTAR-->* NECE BITI SELEKTOVAN)

**:blank** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (MENJAJU JOJ IME U **:whitespace-only** (VEROVATNO, ODNOSNO POSTOJI [dispute](https://github.com/w3c/csswg-drafts/issues/1967))) (NIJE JOS PODRZANA NIGDE)

***KOREN (`<html>...</html>`; ILI U SHADOW DOM-U, NESTO DRUGO):***

**:root**

***PARENT SELECTOR (ANCESTOR SELECTOR), ILI PSEUDO KLASA KOJA SELEKTUJE U ODNOSU NA ANCESTOR-DESCENDANT RELATION (TREBA TEK DA BUDE UVEDEN)***

**:has()**

*******

MOZDA JE DOBRO DA SE OVDE SPOMENU I GRID STRUCTURALNE SELEKTORE (ODNOSNO OSTAVICU LINK SPECIFIKACIJA)

[GRID STRUCTURAL SELECTORS](https://drafts.csswg.org/selectors-4/#table-pseudos) (JOS IH NAZIVAJU I TABLE PSEUDOS)

TU JE U PITANJU

**||** &nbsp;&nbsp;&nbsp;&nbsp; COLUMN KOMBINATOR

I SLEDECI PSEUDO ELEMENTI
