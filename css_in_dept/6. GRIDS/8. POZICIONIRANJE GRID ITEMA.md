...
[SVAKI GRID LINE JE, USTVARI PREDSTAVLJEN SA DVA BROJA (JEDNIM POZITIVNIM I JEDNIM NEGATIVNIM) (ALI OVDE SE RADI SAMO O GRID LINE-OVIMA, KOJI SU UZ EKSPLICITNE TRACK-OVE)](#negativni-broj-grid-line-a-i-protezanje-grid-line-a-kroz-implicitnost)
...
```JAVASCRIPT
    // NAIME, SVAKA LINIJA OVDE IMA SVOJU POZITIVNU I NEGATIVNU NUMERACIJU
    
    // ALI OSIM LINIJA KOJE DELE IMPLICITNU KOLONU OD IMPLICITNE KOLONE

    // I OSIM LINIJA KOJE DELE IMPLICITNI RED OD IMPLICITNOG REDA
    ...
    // ALI SAM OZNACIO I ONE REDOVE I KOLONE, KOJE RAZDVAJAJU IMPLICITNE KOLONE OD IMPLICITNIH KOLONA
    // I ONE LINIJE KOJE DELE IMPLICITNE REDOVE OD IMPLICITNIH REDOVA

    // PRIMECUS DA TE KOLONE NEMAJU DVE CIFRE (ZASTO OBJASNICU U POSEBNOM NASLOVU (SLEDECI NASLOV))
...
### GRID LINIJE, POTPUNE IMPLICITNOSTI
...
```JAVASCRIPT
    ...
    // PRIMECUS DA TE KOLONE NEMAJU DVE CIFRE
...
**GRID LINIJE, CIJE SAM BROJEVE STAVIO U DUPLE ZAGRADE, SU ONE LINIJE, KOJE RAZDVAJAJU IMPLICITNE TRACK-OVE, JEDNE OD DRUGIH; I TE LINIJE, NEMAJU DUPLU NUMERACIJU**
...
I TE IMPLICITNE KOLONE I REDOVI, POSTAJ UDEO MOG GRIDA

MOGU ZADATI BORDER NA NIVOU GRIDA, I UVERIO BI SE U POMENUTO, AL ITO BI TREBAL ODA BUDE LOGICNO
...
I DA TO ZAISTA MOGUCE, A TO CU PRIKAZATI U ODVOJENOM md FAJLU

[AUTOMATSKA VELICINA TRACK-OVA](./11.%20VELICINA%20IMPLICITNIH%20REDOVA%20I%20KOLONA.md)
...
ALI POSTOJI MOGUCNOST DA SE DEFINISE VELICINA IMPLICITNIH REDOVA/KOLONA (STO SAM POKAZAO U ODVOJENOM FAJLU)
