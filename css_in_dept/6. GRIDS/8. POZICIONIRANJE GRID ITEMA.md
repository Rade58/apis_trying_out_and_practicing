...
.myGrid {
    grid-template: repeat(4, 58px) / repeat(4, 1fr);
}
...
```JAVASCRIPT
    ...
    .myGrid
        ...
        1 _|_____|______ |_________|_______ |______ -5
           |     |       |         |        |
           |.item|       |         |        |
...
TAKO DA OKO OVOG MOG GRIDA, ODNOSNO OKO EKSPLICITNO DEFINISANOG BROJA KOLONA I REDOVA
...
SE NALAZI CITAV `IMPLICITNI DEO`
...
```JAVASCRIPT
  ...
  |     |         |         |       |          |          |           |         |         |           |  
  |     |         |         |       |          |          |           |         |         |           |  
 1__________________________________________________________________________________________________________ -5
  |     |         |         |       |          |          |           |         |         |           |  
  |     |         |         |       |    G     |    G     |    G      |    G    |         |           |  
  |     |         |         |       |          |          |           |         |         |           |  
 2__________________________________________________________________________________________________________ -4
  |     |         |         |       |          |          |           |         |         |           |  
  |     |         |         |       |    G     |    G     |    G      |    G    |         |           |  
  |     |         |         |       |          |          |           |         |         |           |  
 3__________________________________________________________________________________________________________ -3
  |     |         |         |       |          |          |           |         |         |           |  
  |     |         |         |       |    G     |    G     |     G     |    G    |         |           |  
  |     |         |         |       |          |          |           |         |         |           |  
  4__________________________________________________________________________________________________________ -2
  |     |         |         |       |          |          |           |         |         |           |  
  |     |         |         |       |    G     |    G     |    G      |    G    |         |           |  
  |     |         |         |       |          |          |           |         |         |           |  
  5__________________________________________________________________________________________________________ -1
  |     |         |         |       |          |          |           |         |         |           |  
  |     |         |         |       |          |          |           |         |         |           |  
  |     |         |         |       |          |          |           |         |         |           |  
  __________________________________________________________________________________________________________
...
**KOJI JE ISTO `VALIDNI PLAYGROUND` NA KOJI MOGU DEFINISATI DA SE PROSTIRU GRID ITEMI, TAKO STO CU KORISTITI, POMENUTE PROPERTIJE:**
