...
- POZITIVNI BROJEVI VERTIKALNIH GRID LINE-OVA SE KORISTE, KADA SE VERTIKALNI GRID LINEOVI PREBROJAVAJU SA LEVE NA DESNU STRANU (DAKLE REC JE O POZITIVNIM CELIM BROJEVIMA OD 1 DO BROJA ONE VERTIKLANE GRID LINIJE KOJA SE NALAZI NAKON POSLEDNJE EKSPLICITNE KOLONE, KOJA JE (ZAJEDNO SA OSTALIM KOLONAMA) DEFINISANA grid-template-column PROPERTIJEM, ILI SHORTHAND-OM grid-template)

- POZITIVNI BROJEVI HORIZONTALNIH GRID LINE-OVA SE KORISTE, KADA SE HORIZONTALNI GRID LINEOVI PREBROJAVAJU SA ODOZGO PREMA DOLE (DAKLE REC JE O POZITIVNIM CELIM BROJEVIMA OD 1 DO BROJA ONE HORIZONTALNE GRID LINIJE KOJA SE NALAZI NAKON POSLEDNJEG EKSPLICITNOG REDA, KOJI JE (ZAJEDNO SA OSTALIM REDOVIMA) DEFINISAN grid-template-row PROPERTIJEM, ILI ISHORTHAND-OM grid-template)
...
I UPRAVO JE TAKVA NEGATIVNA NUMERACIJA GRID LINIJA, KOJE SE NALAZE PORED EKSPLICITNIH TRACK-OVA, KOJU MOGU VIDETI I U DEV TOOLS-U (ZATO OPET NAPOMINJEM, UVEK SE TREBA KORISTITI DEV TOOLS)
