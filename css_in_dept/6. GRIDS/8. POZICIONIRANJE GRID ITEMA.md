...
HAJDE DA, UZ POMOC, **grid-row** I **grid-column** SHORTHAND-A, DEFINISEM DA SE GRID ITEM, PRIKAZAN GORE, USTVARI PROSTIRE, PREKO CETRI GRID CELIJE, KOJE SAM GORE OZNACIO SA `O`

```CSS

.myGrid > .item {
                                                /* 'OKRENUTE VREDNOSTI' (ISTO VALIDNE) */
