...
<iframe width="560" height="315" src="https://estelle.github.io/cssmastery/flexbox/files/axes.html" frameborder="0" allowfullscreen></iframe>
...
1. ZA JEZIKE, KOJI SE PISU ODOZGO PREMA DOLE (ISTOCNO-AZIJSKI), KORISTI SE **flex-direction**: **column**; A **MAIN AXIS** IMA **VERTIKALNI PRAVAC**, A **SMER** JOJ JE **ODOZGO PREMA DOLE**;