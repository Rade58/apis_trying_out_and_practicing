...
DAKLE, SADA KADA BUDEM POCEO UNOS U input ELEMENT, UNCEU VALIDNU VREDNOST, I ONO STO CE SE STAMPATI U KONZOLI, JESTE [OVO](../xim_prac/validity1.PNG)
...
A KADA BUDEM SADA UNEO NEVALIDNU VREDNOST, **ZAISTA CE BITI TRANZICIJE (KOJA TRAJE 3 SEKUNDE)** BACKGROUND COLORA, U CRVENU BOJU, A [OVO JE I JAVASCRIPT DOKAZ, DA VAZE VREDNOSTI KOJE SAM DEFINISAO ZA TRANSITION](../xim_prac/validity2.PNG), JER JE SADA ELEMENT NEVALIDAN, I SAMO TADA VAZE VREDNSOTI PROPERTIJA KOJE SAM DEFINISAO
