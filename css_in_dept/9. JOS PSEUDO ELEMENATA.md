...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **pseudo** ATRIBUT SA ODGOVARAJUCOM -webkit PREFIXED VREDNOSCU

TE VREDNOSTI **pseudo** *ATRIBUTA* JESU IMENA PSEUDO ELEMNATA

KOJA KASNIJE MOGU KORISTITI DA BI STILIZOVAO ODREDJENI ELEMENT SHADOW DOM-A (KONKRETNO VIDEO IMA VELIKI BROJ TIH ELEMENATA, KAO STO SU thumb ILI track)
