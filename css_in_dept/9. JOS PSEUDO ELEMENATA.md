...
MEDJUTIM JA *NISAM VIDEO PSEUDO ELEMENTE, U POMENUTOJ **Style / Computed Style /  :green_check_mark: (Show all (Chrome/opera) ILI (Browser styles*(Firefox)))** SEKCIJI DEV TOOLS-A*
