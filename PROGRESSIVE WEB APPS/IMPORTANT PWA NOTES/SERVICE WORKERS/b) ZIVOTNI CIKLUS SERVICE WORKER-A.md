...
SADA CU DEFINISATI PRIMER, U KOJEM CU KORISTITI clients.claim() **(ISTI PRIMER KAO SA SLIKOM MACKE I PSA, ALI U OVOM SLUCAJU KORISTIM DRUGE SLIKE, ALI TO NIJE NI BITNO; BITNO JE DA CU KORISTITI clients.claim() U onactivate HANDLERU, A TO clients.claim() CE BITI ARGUMENT event.waitUntil() POZIVANJA)**
...
self.addEventListener('activate', function(ev){
    ...
    // OVD E SAM DEFINISAO CLAIMING SVIH CLIENAT-A
