...
locationButton.addEventListener('click', ev => {
    ...
    window.navigator.geolocation.getCurrentPosition(
        ...
        err => {
            console.log(err);
            alert('Cpuldn\'t get location...Try adding it manually')

            // OVDE ONA VARIJABLA fetchedLocation TREBA DA IMA null
...
locationButton.addEventListener('click', ev => {
    ...
    window.navigator.geolocation.getCurrentPosition(
        position => {
            ...
            document.querySelector('input#location').value = "Crete";
        ...
        err => {
            ...
            // 
            fetchedLocation = {lat: null, lon: 0};
