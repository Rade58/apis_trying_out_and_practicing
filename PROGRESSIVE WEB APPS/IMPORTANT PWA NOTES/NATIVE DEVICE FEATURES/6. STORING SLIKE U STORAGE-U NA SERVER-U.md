...
form.addEventListener('submit', ev => {
    ...
    if('serviceWorker' in window.navigator && 'SyncManager' in window){
        ...
        // ALI U SLUCAJU KADA BROWSER PODRZAVA SericeWorker I SyncManager
...
I POMENUTI MODUL (KADA NAD NJIM PRIMENIM rename FUNKCIJU) CE MI POSLUZITI DA **PROCITAM PATH FILE-A, KOJI JE REPRESENTED BY Blob; JER ON CUVA TU INFORMACIJU, KOJ IJE POSLAT**; **A POSLUZICE MI I DA FAJL SLIKE STAVIM U TEMPORARY FOLDER NA CLOUD-U**; I DA FAJLU DAM ZELJENO IME (ALI DACU ONO ISTO IME, KOJE SAM ZADAO PRI FORMIRANJU FormData, PRE SLANJA)
...
exports.storePostData = functions.https.onRequest(function (request, response) {
    ...
    cors(request, response, function () {
        ...
        formData.parse(request, function(err, fields, files){
            ...
            // SADA NA POMENUTOM MODULU PRIMENJUJEM rename FUNKCIJU
