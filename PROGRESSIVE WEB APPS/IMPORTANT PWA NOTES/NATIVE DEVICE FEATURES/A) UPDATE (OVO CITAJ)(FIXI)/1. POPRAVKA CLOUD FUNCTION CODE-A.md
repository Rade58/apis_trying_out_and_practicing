...
ONO STO PREDPOSTAVLJAM JESTO, POSTO U FIREBASE-U, NE MOGU EXTRAHOVATI FormData, JESTE DA KORISTIM

**AKO ZNAS IME FAJLA I AKO SI PRISTUPIO, POMENUTOM DIREKTORIJUMU, MOZES LAKO INICIRATI UPLOAD** (ALI NEMAM PRISTUP FAJLOVIMA U TEMP FOLDERU OPERATIVNOG SISTEMA, PREKO OVOG PAKETA)
...
**ALI MEDJ UTIM PODACIMA NECE BITI INFO O TEMP DIREKTORIJUMU WINDOWS-A, U KOJEM JE MOJ FILE (IMAGE FILE)**
...
NAIME U MOM SLUCAJU JA CU FUNKCIJI DODATI *PATH* **(SASTAVLJEN OD FOLDERA U TEMP FOLDERU WINDOWS-A GDE SE FAJL NALAZI, I IMENA FAJLA)**
...
PREDPOSTAVLJAM DA JE OVO FINAL COG U PROCESU UPLOADING-A
...
const UUID = require('uuid-v4');            // OVO SE KORISTI UZ '@google-cloud/storage' (REKA OSAM DA GA NECU KORISTITI)
// ALI NEKA OSTANE OVAJ PAKET AKO '@google-cloud/storage' BUDE IPAK BIO POTREBAN, MADA NE VERUJEM DA CE BITI
