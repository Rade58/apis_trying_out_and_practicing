...
<script>
    ...
    const slika = document.querySelector('div.blah > img');
...
### :two: DOBRO, U OVOIM PRIMERU, SLACU SAMO JSON DATA, ODNSNO POKUSACU DA POSALJEM JEDAN STRINGIFIED Uint8Array, KOJI ZELIM DA 

PA JEDINO STO MI PADA NA PAMET U TAKVOM SLUCAJU JESTE SLANJE STRIGIFIED Uint8Array-A, SA OSTALIM JSON PODACIMA

JA CU IPAK POKUSATI DA ISPROBAM DRUGACIJI PRINCIP PO KOJEM CU OPET SLATI BINARNU VREDNOST, UZ POMOC JSON-A
