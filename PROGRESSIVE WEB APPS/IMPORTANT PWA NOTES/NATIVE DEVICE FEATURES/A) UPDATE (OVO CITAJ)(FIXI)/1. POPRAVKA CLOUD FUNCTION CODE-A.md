...
exports.createPostBlah = functions.https.onRequest(async (request, response) => {
    ...
    const databsePlaceRef = database.ref('blahPost').push();    // TAKO RECI, KADA BUDEM KORISTIO OVU REFERENCU
    ...
    try{
        ...
        const uint8 = new Uint8Array(`[${fileString}]`);  // DAKLE OD OVOGA OVDE ZELI MDA KREIRAM Buffer
        ...
        response.status(200).json({message: "data is here"})
