...
### :two::cold_sweat: ISPITACU DA LI SE MOZE FIREBASE-OV storage PAKET KORISTITI NA CLOUD STRANI; A KONKRETNO STA JA ZELIM DA URADIM, JESTE DA DO ENDPOINT-A (CLUD FUNKCIJE), POSALJEM ILI Base64 STRING ILI ArrayBuffer ILI Unit8Array
...
**DA ODMAH KAZEM DA JE SLANJE FAJLA, KORISCENJEM HTTP REQUESTA MOGUCE POSTICI, SAMO KREIRANJEM *FormData* INSTANCE, NA KOJU BI APPEND-OVAO FAJL** (JEDINI NACIN ZA KOJI JA ZNAM KADA KORISTIM fetch API)
