...
### ZELIM SADA DA ODRADIM JEDAN PRIMER, JESTE DA DO ENDPOINT-A (CLUD FUNKCIJE), POSALJEM ILI Base64 STRING ILI ArrayBuffer, ILI Uint8Array; PA DA ISKORISTIM FIREBASE firestore LIBRARY, ILI FIRESTORE-OV real time database (DAKLE JA SADA ZELIM DA NE KORISTI MSTORAGE UOPSTE, PRILIKOM 'UPLOADING'-A (POD NAVODNICIMA VELIKIM, JER NIST NE UPLOAD-UJEM VEC STORE-UJEM BINARNU VREDNOST U DATBASE-U))

DAKLE SACUVO BIH ODREDJENI TIP VREDNSOTI KOJI CE NA IDIREKTANA NACIN PREDSTAVLJATI 'FAJL' (U PITANJU JE NIZ OD KOJEG SE 'BIANRNIM PUTEM', MOZE, OPET SAGRADITI Blob INSTANCA, KADA NIZ FETCHUJEM NAZAD NA CLIENT-U))
...
- ALI [ArrayBuffer](https://javascript.info/arraybuffer-binary-arrays) IMA GOTOVO ISTI SYZE U BYTE-OVIMA (MALO JE MANJI ALI PRIBLIZNO ISTI), NEGO BASE64
...
**CAK SAM IM IZMERIO BYTE SIZE U JEDNOM PRIMERU, I ON IZNOSI GOTOVO ISTO ZA OBAS TIPA BINARNR VREDNOSTI**
