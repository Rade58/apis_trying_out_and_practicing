...
workbox.routing.registerRoute(
    ...
    async ({url, event, params}) => {
        ...
        try{
            ...
            const assetCacheKey = workbox.precaching.getCacheKeyForURL(event.request.url);
            ...
            console.log("PULLING HTML FALLBACK FROM CACHE")

            // I OVDE PRISTUPAM SPECIFICNOM KEYU, ODNOSNO TO JE URL KOJEM JE DODAT KEY
