...
// PREDHODNOJ FUNKCIJI SE NE PROSLEDJUJE CEO OBJEKAT, VEC SAMO PROPERTI env OBJEKATA (POKUSAO SAM DA PROSLEDIM TEMPLATE STRINGU env.mode (**** DOBIO ERROR))
// ODNOSNO POKUSAO SM DA NA TAJ NACIN DEFINISEM FUNKCIJU, I KADA SAM RUNN-OVAO PRODUCTIO NSCRIPT, DOBIO SAM ERROR (TAK ODA TREBAM DA SE DRZIM OVOGA STO SAM
// SADA DEFINISAO)
